...
@Entity
@Table(name = "business_cust_master_general_info_slave")
@Component
@JsonDeserialize(as = BusinessCustMasterGenralInfoDto.class)
public class BusinessCustMasterGenralInfoDto {
	...
	public String toString() {
		return "BusinessCustMasterGenralInfoDto [id=" + id + ", mobile=" + mobile
				+ ", landline=" + landline + ", website=" + website
				+ ", pancardNo=" + pancardNo + ", gstTransactionNo="
				+ gstTransactionNo + ", mail=" + mail + ", createdBy="
				...
				+ ", businessMasterGeneralInfoDto=" + businessMasterGeneralInfoDto
				+ "]";
	}
