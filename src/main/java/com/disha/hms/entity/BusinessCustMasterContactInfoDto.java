...
@Entity
@Table(name = "business_master_contact_info_slave")
@Component
public class BusinessCustMasterContactInfoDto implements Serializable {
	...
	@Column(name = "contact_info_designation")
	private String contactDesignation;

	@Column(name = "contact_info_address")
	private String contactAddress;

	@Column(name = "contact_info_gender")
	private String contactGender;

	@Column(name = "contact_info_dob")
	private String contactDob;

	@Column(name = "contact_info_phone_number1")
	private String contactPhoneNumber1;

	@Column(name = "contact_info_phone_number2")
	...
	public String toString() {
		return "BusinessCustMasterContactInfoDto [id=" + id + ", contactName="
				...
				+ ", unitId=" + unitId + ", businessMasterContactInfoDto="
